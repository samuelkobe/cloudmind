...
<div class="w-full pt-10 lg:pt-[calc(10dvh_-_2rem)] first:!pt-0 lg:text-<?php echo $text_alignment;?>">
  ...
  <?php endif; ?>
  <h2 class="font-bold text-3xl lg:text-[32px] 2xl:text-[40px] lg:leading-tight <?php echo $heading_colour;?>"><?php echo get_sub_field( 'heading' ); ?></h2>
